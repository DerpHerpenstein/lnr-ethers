...
Callable by the domain owner, this function delegates a controller address that will be able to use this domain like it belongs to them. (Note: domain must be unwrapped)
```
